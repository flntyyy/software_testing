 ...
 * 2019-02-17T13:02:36.668+03:00
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "GeoIPService", 
                  wsdlLocation = "src/main/resources/ipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("src/main/resources/ipservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "src/main/resources/ipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
